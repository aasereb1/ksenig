...
(function (global) {
  ...
  // Лицо робота: фиксированные цвета, без привязки к теме страницы (#313136 = --copilot-trigger-face в copilot-robot.css)
  function faceMarkup() {
    return (
      ...
      '<rect x="12" y="16" width="7" height="18" rx="3" fill="#ffffff"/></g>' +
      '<g class="copilot-eye-group copilot-eye-right" transform="translate(0,0)">' +
      '<rect x="30" y="16" width="7" height="18" rx="3" fill="#ffffff"/></g>' +
      '</svg></span>'
    );
  }
